...
<h3 id = "ti">  Demandes de covoituage </h3> <br>
...
<div class="modal fade" id="ajout" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('demande/ajouter');?>">
      <div class="modal-body">
        ...
        <input type="text" class="form-control" id="prenom" placeholder="où voulez vous vous rendre? " name="destination" required>
        </div>
        <div class="col">
        ...
        <div class="col">
        <label for="nbre_place">nombre de place demandées:</label>
        <input type="number" class="form-control" id="prenom" placeholder="Combien de place demandez vous?" name="nbre_place" required>
        </div>
      </div>
    ...
    <table>
        ...
        <tbody>
            <?php foreach($tableau as $tab): ?>
                <tr>
                    <td><?php echo $tab->ID_demande; ?></td>
                    <td><?php echo $tab->Nom; ?> <?php echo $tab->Prenom; ?></td>
                    <td><?php echo $tab->Numero; ?></td>
                    <td><?php echo $tab->depart_souhaiter; ?></td>
                    <td><?php echo $tab->arivee_souhaiter; ?></td>
                    <td><?php echo $tab->date_souhaiter; ?></td>
                    <td><?php echo $tab->heure_souhaiter; ?></td>
                    <td><?php echo $tab->nbre_place_demander; ?></td>
                    <td><button class="btn btn-warning btn-block" id="">Accepter</button></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
